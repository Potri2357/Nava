...
export default async function IntelligencePage({ searchParams }: { searchParams: Promise<{ job?: string }> }) {
  ...
  return (
    <AppShell>
      <PageHeader
        ...
        title="Role-Based Shortlist"
        description="Rank candidates against the selected role with explainable score dimensions, evidence, concerns, comparison, and export."
      />
